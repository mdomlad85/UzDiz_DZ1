...
namespace ToF.Vendor
{
    public class ConsoleTable
    {
        ...
        public void Write(Vendor.Format format = Vendor.Format.Default)
        {
            switch (format)
            {
                case Vendor.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case Vendor.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case Vendor.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case Vendor.Format.Minimal:
